...
enum CURRENCIES {GOLD = 0, NOTHING = 1, KEY1 = 2, KEY2 = 3, KEY3 = 4}
enum ITEMRARITY {COMMON = 1, UNCOMMON = 2, RARE = 3, EXQUISITE = 4, LEGENDARY = 5}
enum GEARTYPE {HELMET = 0, CHEST = 1, PANTS = 2, ACCESSORY = 3, WEAPON = 4}
enum WEAPONTYPE {SWORD = 0, WAND = 1, KNIFE = 2, HAMMER = 3, BOW = 4, GRIMOIRE = 5}
